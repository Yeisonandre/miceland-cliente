                                 ...
                                 badge.style.display = "none";
                                   ...
                                   /* ---------------------------------------------------------
                                      AGREGAR AL CARRITO (desde la tarjeta, con el botón "+")
                                         Si es invitado, no lo dejamos agregar: lo mandamos a
                                            crear una cuenta primero.
                                            --------------------------------------------------------- */
                                            function agregarAlCarrito(codigo, cantidad){
                                              if(MODO_INVITADO || !auth.currentUser){
                                                  mostrarFormulario("registro");
                                                      mostrarError("Creá una cuenta para poder agregar productos al carrito.");
                                                          return;
                                                            }
